 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var p_;function rA(){return p_||(p_=1,function(t){function e(X,he){var le=X.length;X.push(he);e:for(;0<le;){var me=le-1>>>1,P=X[me];if(0<s(P,he))X[me]=he,X[le]=P,le=me;else break e}}function n(X){return X.length===0?null:X[0]}function a(X){if(X.length===0)return null;var he=X[0],le=X.pop();if(le!==he){X[0]=le;e:for(var me=0,P=X.length,te=P>>>1;me<te;){var ue=2*(me+1)-1,se=X[ue],pe=ue+1,Ee=X[pe];if(0>s(se,le))pe<P&&0>s(Ee,se)?(X[me]=Ee,X[pe]=le,me=pe):(X[me]=se,X[ue]=le,me=ue);else if(pe<P&&0>s(Ee,le))X[me]=Ee,X[pe]=le,me=pe;else break e}}return he}function s(X,he){var le=X.sortIndex-he.sortIndex;return le!==0?le:X.id-he.id}if(t.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var l=performance;t.unstable_now=function(){return l.now()}}else{var h=Date,d=h.now();t.unstable_now=function(){return h.now()-d}}var g=[],m=[],_=1,E=null,w=3,C=!1,O=!1,z=!1,k=!1,V=typeof setTimeout=="function"?setTimeout:null,B=typeof clearTimeout=="function"?clearTimeout:null,W=typeof setImmediate<"u"?setImmediate:null;function J(X){for(var he=n(m);he!==null;){if(he.callback===null)a(m);else if(he.startTime<=X)a(m),he.sortIndex=he.expirationTime,e(g,he);else break;he=n(m)}}function re(X){if(z=!1,J(X),!O)if(n(g)!==null)O=!0,ce||(ce=!0,H());else{var he=n(m);he!==null&&Qe(re,he.startTime-X)}}var ce=!1,D=-1,A=5,I=-1;function j(){return k?!0:!(t.unstable_now()-I<A)}function U(){if(k=!1,ce){var X=t.unstable_now();I=X;var he=!0;try{e:{O=!1,z&&(z=!1,B(D),D=-1),C=!0;var le=w;try{t:{for(J(X),E=n(g);E!==null&&!(E.expirationTime>X&&j());){var me=E.callback;if(typeof me=="function"){E.callback=null,w=E.priorityLevel;var P=me(E.expirationTime<=X);if(X=t.unstable_now(),typeof P=="function"){E.callback=P,J(X),he=!0;break t}E===n(g)&&a(g),J(X)}else a(g);E=n(g)}if(E!==null)he=!0;else{var te=n(m);te!==null&&Qe(re,te.startTime-X),he=!1}}break e}finally{E=null,w=le,C=!1}he=void 0}}finally{he?H():ce=!1}}}var H;if(typeof W=="function")H=function(){W(U)};else if(typeof MessageChannel<"u"){var M=new MessageChannel,et=M.port2;M.port1.onmessage=U,H=function(){et.postMessage(null)}}else H=function(){V(U,0)};function Qe(X,he){D=V(function(){X(t.unstable_now())},he)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(X){X.callback=null},t.unstable_forceFrameRate=function(X){0>X||125<X?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<X?Math.floor(1e3/X):5},t.unstable_getCurrentPriorityLevel=function(){return w},t.unstable_next=function(X){switch(w){case 1:case 2:case 3:var he=3;break;default:he=w}var le=w;w=he;try{return X()}finally{w=le}},t.unstable_requestPaint=function(){k=!0},t.unstable_runWithPriority=function(X,he){switch(X){case 1:case 2:case 3:case 4:case 5:break;default:X=3}var le=w;w=X;try{return he()}finally{w=le}},t.unstable_scheduleCallback=function(X,he,le){var me=t.unstable_now();switch(typeof le=="object"&&le!==null?(le=le.delay,le=typeof le=="number"&&0<le?me+le:me):le=me,X){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=le+P,X={id:_++,callback:he,priorityLevel:X,startTime:le,expirationTime:P,sortIndex:-1},le>me?(X.sortIndex=le,e(m,X),n(g)===null&&X===n(m)&&(z?(B(D),D=-1):z=!0,Qe(re,le-me))):(X.sortIndex=P,e(g,X),O||C||(O=!0,ce||(ce=!0,H()))),X},t.unstable_shouldYield=j,t.unstable_wrapCallback=function(X){var he=w;return function(){var le=w;w=he;try{return X.apply(this,arguments)}finally{w=le}}}}(pg)),pg}var g_;function iA(){return g_||(g_=1,dg.exports=rA()),dg.exports}var gg={exports:{}},mn={};/**
 * @license React
...
`,YC=R.div`
  ...
  text-align: center;
`,WC=({currentStep:t=0})=>{const n=["모집중","모집완료","결제대기","배송중"],a=t/3*100;return v.jsxs(BC,{children:[v.jsxs(HC,{children:[v.jsx(GC,{}),v.jsx($C,{$progress:a}),[...Array(4)].map((s,l)=>v.jsxs(FC,{$active:l===t,$completed:l<t,children:[l===t&&v.jsx("img",{src:"/Team3-WebApp//dot.svg",alt:"현재 단계"}),l<t&&v.jsx("img",{src:"/Team3-WebApp//check.svg",alt:"완료됨"})]},l))]}),v.jsx(qC,{children:n.map((s,l)=>v.jsx(YC,{$active:l<=t,children:s},s))})]})},KC=R.div`
  display: flex;
  align-items: center;
  gap: 2px;
`,QC=R.span`
...
`,JC=R.span`
  color: #797979;
`;function Qm({current:t=0,total:e=0}){return v.jsxs(KC,{children:[v.jsx(QC,{children:v.jsx("img",{src:"/Team3-WebApp//participant.svg",alt:""})}),v.jsxs(XC,{children:[v.jsx(ZC,{children:t}),v.jsxs(JC,{children:["/",e]})]})]})}const eR=R.div`
  font-size: 16px;
  font-weight: 600;
  line-height: 24px;
...
`,nR=R.span`
  ...
  line-height: 150%; /* 24px */
  letter-spacing: -0.4px;
`;function Xm({amount:t="1,100원",unit:e="/ 인",color:n="#426bff",unitColor:a="#66686E"}){return v.jsxs(eR,{children:[v.jsx(tR,{style:{color:n},children:`${t==null?void 0:t.toLocaleString()}원 `}),v.jsx(nR,{style:{color:a},children:e})]})}const rR=R.div`
  display: flex;
  justify-content: center;
  align-items: center;
  ...
  width: fit-content;
`;function Ku({label:t}){const e=new Date,n=new Date(t);let a=`${Math.ceil((n-e)/(1e3*60*60*24))}`;return a<0?a="마감됨":a>0?a=`D-${a}`:a="D-Day",v.jsx(rR,{children:a})}const iR=R.h2`
  color: #333;
  font-family: Pretendard;
  font-size: 16px;
  font-style: normal;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class b5{constructor(e){this.serializer=e,this.kr=new Map,this.qr=new Map}getBundleMetadata(e,n){return ae.resolve(this.kr.get(n))}saveBundleMetadata(e,n){return this.kr.set(n.id,function(s){return{id:s.id,version:s.version,createTime:Wr(s.createTime)}}(n)),ae.resolve()}getNamedQuery(e,n){return ae.resolve(this.qr.get(n))}saveNamedQuery(e,n){return this.qr.set(n.name,function(s){return{name:s.name,query:c5(s.bundledQuery),readTime:Wr(s.readTime)}}(n)),ae.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class w5{constructor(){this.overlays=new wt(xe.comparator),this.Qr=new Map}getOverlay(e,n){return ae.resolve(this.overlays.get(n))}getOverlays(e,n){const a=ws();return ae.forEach(n,s=>this.getOverlay(e,s).next(l=>{l!==null&&a.set(s,l)})).next(()=>a)}saveOverlays(e,n,a){return a.forEach((s,l)=>{this.bt(e,n,l)}),ae.resolve()}removeOverlaysForBatchId(e,n,a){const s=this.Qr.get(a);return s!==void 0&&(s.forEach(l=>this.overlays=this.overlays.remove(l)),this.Qr.delete(a)),ae.resolve()}getOverlaysForCollection(e,n,a){const s=ws(),l=n.length+1,h=new xe(n.child("")),d=this.overlays.getIteratorFrom(h);for(;d.hasNext();){const g=d.getNext().value,m=g.getKey();if(!n.isPrefixOf(m.path))break;m.path.length===l&&g.largestBatchId>a&&s.set(g.getKey(),g)}return ae.resolve(s)}getOverlaysForCollectionGroup(e,n,a,s){let l=new wt((m,_)=>m-_);const h=this.overlays.getIterator();for(;h.hasNext();){const m=h.getNext().value;if(m.getKey().getCollectionGroup()===n&&m.largestBatchId>a){let _=l.get(m.largestBatchId);_===null&&(_=ws(),l=l.insert(m.largestBatchId,_)),_.set(m.getKey(),m)}}const d=ws(),g=l.getIterator();for(;g.hasNext()&&(g.getNext().value.forEach((m,_)=>d.set(m,_)),!(d.size()>=s)););return ae.resolve(d)}bt(e,n,a){const s=this.overlays.get(a.key);if(s!==null){const h=this.Qr.get(s.largestBatchId).delete(a.key);this.Qr.set(s.largestBatchId,h)}this.overlays=this.overlays.insert(a.key,new BD(n,a));let l=this.Qr.get(n);l===void 0&&(l=Be(),this.Qr.set(n,l)),this.Qr.set(n,l.add(a.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class T5{constructor(e,n){this.indexManager=e,this.referenceDelegate=n,this.mutationQueue=[],this.nr=1,this.Xr=new Ft(Xt.Ur)}checkEmpty(e){return ae.resolve(this.mutationQueue.length===0)}addMutationBatch(e,n,a,s){const l=this.nr;this.nr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const h=new zD(l,n,a,s);this.mutationQueue.push(h);for(const d of s)this.Xr=this.Xr.add(new Xt(d.key,l)),this.indexManager.addToCollectionParentIndex(e,d.key.path.popLast());return ae.resolve(h)}lookupMutationBatch(e,n){return ae.resolve(this.ei(n))}getNextMutationBatchAfterBatchId(e,n){const a=n+1,s=this.ti(a),l=s<0?0:s;return ae.resolve(this.mutationQueue.length>l?this.mutationQueue[l]:null)}getHighestUnacknowledgedBatchId(){return ae.resolve(this.mutationQueue.length===0?fy:this.nr-1)}getAllMutationBatches(e){return ae.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,n){const a=new Xt(n,0),s=new Xt(n,Number.POSITIVE_INFINITY),l=[];return this.Xr.forEachInRange([a,s],h=>{const d=this.ei(h.Zr);l.push(d)}),ae.resolve(l)}getAllMutationBatchesAffectingDocumentKeys(e,n){let a=new Ft(Me);return n.forEach(s=>{const l=new Xt(s,0),h=new Xt(s,Number.POSITIVE_INFINITY);this.Xr.forEachInRange([l,h],d=>{a=a.add(d.Zr)})}),ae.resolve(this.ni(a))}getAllMutationBatchesAffectingQuery(e,n){const a=n.path,s=a.length+1;let l=a;xe.isDocumentKey(l)||(l=l.child(""));const h=new Xt(new xe(l),0);let d=new Ft(Me);return this.Xr.forEachWhile(g=>{const m=g.key.path;return!!a.isPrefixOf(m)&&(m.length===s&&(d=d.add(g.Zr)),!0)},h),ae.resolve(this.ni(d))}ni(e){const n=[];return e.forEach(a=>{const s=this.ei(a);s!==null&&n.push(s)}),n}removeMutationBatch(e,n){Je(this.ri(n.batchId,"removed")===0,55003),this.mutationQueue.shift();let a=this.Xr;return ae.forEach(n.mutations,s=>{const l=new Xt(s.key,n.batchId);return a=a.delete(l),this.referenceDelegate.markPotentiallyOrphaned(e,s.key)}).next(()=>{this.Xr=a})}sr(e){}containsKey(e,n){const a=new Xt(n,0),s=this.Xr.firstAfterOrEqual(a);return ae.resolve(n.isEqual(s&&s.key))}performConsistencyCheck(e){return this.mutationQueue.length,ae.resolve()}ri(e,n){return this.ti(e)}ti(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}ei(e){const n=this.ti(e);return n<0||n>=this.mutationQueue.length?null:this.mutationQueue[n]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,x9=()=>{const[t,e]=F.useState([]),[n,a]=F.useState(0),s=F.useRef(null);F.useEffect(()=>{(async()=>{try{const V=await Hi(ti(Cn,"gongu")),B=[];V.forEach(W=>{B.push({id:W.id,...W.data()})}),console.log("파이어베이스 들고 옴",B),e(B)}catch(V){console.error("Error fetching group buys:",V)}})()},[]);const l=[...t].sort((k,V)=>{var B,W;return(((B=k.createdAt)==null?void 0:B.seconds)||0)-(((W=V.createdAt)==null?void 0:W.seconds)||0)}).slice(3,7),h=()=>{a(k=>k===0?l.length-1:k-1)},d=()=>{a(k=>k===l.length-1?0:k+1)},g=F.useRef(null),m=F.useRef(null),_=F.useRef(!1),E=k=>{g.current=k.touches[0].clientX},w=k=>{if(g.current===null)return;const V=k.changedTouches[0].clientX,B=g.current-V;B>50?d():B<-50&&h(),g.current=null},C=k=>{_.current=!0,m.current=k.clientX},O=k=>{if(!_.current||m.current===null)return;const V=k.clientX,B=m.current-V;B>50?d():B<-50&&h(),_.current=!1,m.current=null},z=()=>{_.current=!1,m.current=null};return v.jsxs(i9,{children:[v.jsxs(a9,{children:[v.jsx(s9,{children:"진행중인 공구"}),v.jsx(o9,{children:l.length})]}),l.length===0?v.jsx("div",{style:{width:"100%",textAlign:"center",padding:"32px 0"},children:"진행중인 공구가 없습니다."}):v.jsx("div",{style:{width:"100%",overflow:"hidden",padding:"0 0 10px",position:"relative"},ref:s,onTouchStart:E,onTouchEnd:w,onMouseDown:C,onMouseUp:O,onMouseLeave:z,children:v.jsx("div",{style:{display:"flex",transition:"transform 0.4s cubic-bezier(.4,0,.2,1)",transform:`translateX(-${n*100}%)`,width:`${l.length*100}%`},children:l.map((k,V)=>{var B;return v.jsx("div",{style:{flex:"0 0 100%",maxWidth:"100%"},children:v.jsx(l9,{children:v.jsxs(u9,{children:[v.jsxs(c9,{children:[v.jsx(h9,{children:v.jsx(f9,{src:Array.isArray(k.images)&&k.images[0]?k.images[0]:"/placeholder.png",alt:k.title||"product"})}),v.jsxs(d9,{children:[v.jsxs(p9,{children:[v.jsxs(g9,{children:[v.jsx(Zm,{title:k.title,weight:600}),v.jsx(Ku,{label:(B=k.deadline)!=null&&B.seconds?new Date(k.deadline.seconds*1e3):k.deadline})]}),v.jsx(m9,{children:v.jsx(Xm,{amount:k.price&&k.finalnum?Math.floor(k.price/k.finalnum):0})})]}),v.jsx(y9,{children:v.jsx(Qm,{current:Array.isArray(k.participant)?k.participant.length:0,total:k.finalnum||0})})]})]}),v.jsx(WC,{currentStep:(()=>{var D;const W=Array.isArray(k.participant)?k.participant.length:0,J=k.finalnum||0;let re;(D=k.deadline)!=null&&D.seconds?re=new Date(k.deadline.seconds*1e3):(typeof k.deadline=="string"||typeof k.deadline=="number")&&(re=new Date(k.deadline));const ce=new Date;return W>=J&&re&&ce>re?3:W>=J?1:0})(),steps:k.steps})]})})},k.id||V)})})}),v.jsx(v9,{children:[...Array(4)].map((k,V)=>v.jsx(_9,{style:{backgroundColor:V===n?"#4284ff":"#dfdfe1",transition:"background 0.2s"}},V))})]})},b9=R.article`
  display: flex;
  flex-direction: column;
  width: 100%;
...
`,E9=R.div`
  ...
  flex: 1;
  margin: 4px 0 12px;
`;function T9({title:t,price:e,deadline:n,current:a,finalnum:s,onClick:l,images:h}){const d=Array.isArray(h)?h[0]:h;return v.jsxs(b9,{onClick:l,children:[v.jsx(w9,{$image:d}),v.jsx(Ku,{label:n}),v.jsxs(E9,{children:[v.jsx(Zm,{title:t}),v.jsx(Xm,{amount:parseInt(e/s)})]}),v.jsx(Qm,{current:a,total:s})]})}const S9=R.section`
  display: flex;
  flex-direction: column;
  padding: 16px 0;
  width: 100%;
...
`,Z9=R.div`
  ...
  align-items: flex-start;
  align-self: stretch;
`,J9=()=>{const t=bn(),[e,n]=F.useState([]);return F.useEffect(()=>{(async()=>{try{const l=(await Hi(ti(Cn,"review"))).docs.map(h=>({id:h.id,...h.data()})).sort((h,d)=>(d.date??0)-(h.date??0));n(l)}catch(s){console.error("커뮤니티 데이터 불러오기 실패:",s)}})()},[]),v.jsxs(W9,{children:[v.jsxs(K9,{children:[v.jsx(Q9,{children:"커뮤니티"}),v.jsxs(X9,{onClick:()=>t("/community"),children:[v.jsx("p",{children:"전체보기"}),v.jsx("span",{children:v.jsx("img",{src:"/Team3-WebApp//arrow-right-16px.svg",alt:""})})]})]}),v.jsx(Z9,{children:e.length===0?v.jsx("p",{style:{color:"#999",fontSize:"14px"},children:"게시물이 없어요"}):e.slice(0,5).map((a,s)=>v.jsx(JT,{...a,onClick:()=>t(`/community/${a.date}`)},a.id||s))})]})},eO=R.section`
  width: 100%;
`,tO=R.div`
  color: #232428;
  font-size: 24px;
...
`;function xO({categories:t,active:e,onChange:n}){const a=F.useRef(null);let s=!1,l=0,h=0;const d=_=>{s=!0,l=_.pageX-a.current.offsetLeft,h=a.current.scrollLeft},g=_=>{if(!s)return;_.preventDefault();const w=(_.pageX-a.current.offsetLeft-l)*1;a.current.scrollLeft=h-w},m=()=>{s=!1};return v.jsxs(mO,{children:[v.jsx(yO,{ref:a,onMouseDown:d,onMouseMove:g,onMouseUp:m,onMouseLeave:m,children:t.map(_=>v.jsx(vO,{$active:_===e,onClick:()=>n(_),children:_},_))}),v.jsx(_O,{})]})}const bO=R.p`
  ...
  overflow: hidden;
  text-overflow: ellipsis;
`;function wO({body:t="설명이 없습니다"}){return v.jsx(bO,{children:t})}const EO=R.article`
  display: flex;
  padding: 12px 0;
  flex-direction: column;
  align-items: center;
...
`,NO=({filter:t={},gonguList:e=[]})=>{const{search:n,category:a}=t,[s,l]=F.useState([]),h=ei(),d=bn();F.useEffect(()=>{var _;e.length>0?l(e):(_=h.state)!=null&&_.items?l(h.state.items):(async()=>{try{const O=(await Hi(ti(Cn,"gongu"))).docs.map(z=>({id:z.id,...z.data()})).sort((z,k)=>(k.date??0)-(z.date??0));l(O)}catch(w){console.error("공구 리스트 불러오기 실패:",w),l([])}})()},[e,h.state]);const g=_=>{d(`/gongu/${_.id}`,{state:{item:_}})};let m=s;if(a&&a!=="전체"&&(m=m.filter(_=>_.category===a)),n){const _=n.toLowerCase();m=m.filter(E=>{var w,C;return((w=E.title)==null?void 0:w.toLowerCase().includes(_))||((C=E.desc)==null?void 0:C.toLowerCase().includes(_))})}return v.jsx(IO,{children:m.length>0?v.jsx(DO,{children:m.map((_,E)=>{var w,C;return v.jsx(RO,{title:_.title,body:_.body,price:parseInt(_.price/_.finalnum),deadline:_.deadline,current:((w=_.participant)==null?void 0:w.length)||0,total:_.finalnum,image:(C=_.images)==null?void 0:C[0],onClick:()=>g(_)},_.id||E)})}):v.jsxs(OO,{children:[v.jsx("p",{children:"진행중인 공구가 없어요."}),v.jsxs(kO,{onClick:()=>d("/gongu/new"),children:[v.jsx("p",{children:"새로운 공구 올리기"}),v.jsx("span",{children:v.jsx("img",{src:"/Team3-WebApp//arrow-right-blue.svg",alt:">"})})]})]})})},MO=["전체","생수","생필품","식품","의류/학잠","도서","문구","건강식품","뷰티","기타"],PO=R.div`
  display: flex;
  flex-direction: column;
  width: 402px;
  height: 100vh;
...
`,UO=R.button`
  ...
  cursor: pointer;
`;function zO(){const[t,e]=F.useState(""),[n,a]=F.useState("전체"),[s,l]=F.useState([]),h=bn();F.useEffect(()=>{(async()=>{try{const O=(await Hi(ti(Cn,"gongu"))).docs.map(z=>({id:z.id,...z.data()})).sort((z,k)=>(k.date??0)-(z.date??0));l(O)}catch(C){console.error("공구 리스트 불러오기 실패:",C)}})()},[]);const g=s.filter(w=>n==="전체"?!0:w.category===n).filter(w=>{if(!t.trim())return!0;const C=t.toLowerCase().trim(),O=(w.title||"").toLowerCase(),z=(w.content||"").toLowerCase();return O.includes(C)||z.includes(C)}),m=w=>{w&&w.preventDefault(),console.log("검색 실행:",t)},_=()=>{e(""),console.log("검색어 초기화")},E=w=>{e(w.target.value)};return v.jsxs(PO,{children:[v.jsx(jO,{children:v.jsx("img",{src:"/Team3-WebApp//StatusBar.png",alt:"StatusBar"})}),v.jsxs(VO,{children:[v.jsx(gO,{value:t,onChange:E,placeholder:"제목, 내용으로 검색하세요",onSearch:m,onClear:_}),v.jsx(xO,{categories:MO,active:n,onChange:a})]}),v.jsxs(LO,{children:[t.trim()?`"${t}" 검색결과`:n," ",g.length,"개"]}),v.jsx(NO,{filter:{search:t,category:n},gonguList:g}),v.jsx(UO,{onClick:()=>h("/gongu/new"),children:v.jsx("img",{src:"/Team3-WebApp//plus.svg",alt:""})}),v.jsx(sd,{})]})}const BO=R.div`
  display: flex;
  flex-direction: column;
...
`,MN=R.button`
  ...
  letter-spacing: -0.4px;
  cursor: pointer;
`;function PN({onSelectDate:t,onClose:e}){const[n,a]=F.useState(new Date);return v.jsxs(t2,{onClose:e,children:[v.jsx(NN,{value:n,onChange:s=>a(s),locale:"ko-KR",formatMonthYear:(s,l)=>`${l.getFullYear()}년 ${l.getMonth()+1}월`,formatDay:(s,l)=>String(l.getDate()),nextLabel:v.jsx(Rb,{children:v.jsx("img",{src:"/Team3-WebApp//arrow-right.svg",alt:"다음 달"})}),prevLabel:v.jsx(Rb,{children:v.jsx("img",{src:"/Team3-WebApp//arrow-left.svg",alt:"이전 달"})}),next2Label:null,prev2Label:null,onClickLabel:s=>s.preventDefault()}),v.jsx(MN,{onClick:()=>t(n),children:"확인"})]})}const jN=R.div`
  display: flex;
  flex-direction: column;
  width: 402px;
  height: 100vh;
...
`;function t7(t){const e=bn(),[n,a]=F.useState(""),[s,l]=F.useState(""),[h,d]=F.useState(""),[g,m]=F.useState(""),[_,E]=F.useState(""),[w,C]=F.useState(""),[O,z]=F.useState(""),[k,V]=F.useState([]),B=F.useRef(null),W=n&&s.trim()&&h.trim()&&g&&_&&w&&O&&k.length>0,J=le=>le.replace(/[^\d]/g,""),re=le=>le?Number(le).toLocaleString("ko-KR"):"",ce=Number(_)>0&&Number(w)>0?Math.floor(Number(_)/Number(w)):null,[D,A]=F.useState(!1),I=le=>{a(le),A(!1)},[j,U]=F.useState(!1),H=le=>`${le.getFullYear()}년 ${le.getMonth()+1}월 ${le.getDate()}일`,M=le=>{m(H(le)),U(!1)},et=5,Qe=le=>{const me=et-k.length,te=Array.from(le.target.files).slice(0,me).map(ue=>new Promise(se=>{const pe=new FileReader;pe.onload=Ee=>se({name:ue.name,src:Ee.target.result}),pe.readAsDataURL(ue)}));Promise.all(te).then(ue=>V(se=>[...se,...ue]))},X=le=>V(k.filter((me,P)=>P!==le)),he=async()=>{if(W)try{const le=Date.now().toString(),me=rl(Cn,"gongu",le);await KT(me,{id:le,postid:le,title:s.trim(),body:h.trim(),category:n,images:k.map(P=>P.src),price:Number(J(_)),deadline:new Date(g.replace(/년|월/g,"-").replace(/일/g,"")).getTime(),date:le,finalnum:Number(w),currentnum:0,participant:["공구킹 영재_123456"],link:O.trim(),owner:"공구킹 영재_123456",isReviewed:!1}),alert("공동구매 글이 등록되었습니다."),e(-1)}catch(le){alert("등록에 실패했습니다."),console.error(le)}};return v.jsxs(jN,{children:[v.jsx(VN,{children:v.jsx("img",{src:"/Team3-WebApp//StatusBar.png",alt:"StatusBar"})}),v.jsx(Va,{state:"TextActionBar",text:"공동구매 글 작성",iconType:"x",disabled:!W,onClick:he}),v.jsxs(LN,{children:[v.jsx("p",{className:"title",children:"글 작성"}),v.jsxs(UN,{children:[v.jsxs(XN,{children:[v.jsx("label",{children:"카테고리"}),v.jsxs(ZN,{selected:!!n,onClick:()=>A(!0),children:[n||"카테고리를 선택해주세요.",v.jsx("span",{children:v.jsx("img",{src:"/Team3-WebApp//arrow-down.svg",alt:""})})]})]}),v.jsx(Mo,{label:"제목",placeholder:"제목을 입력해주세요",charLimit:18,value:s,onChange:le=>l(le.target.value)}),v.jsx(Mo,{label:"내용",placeholder:"공구할 상품에 대한 설명을 입력해주세요",textarea:!0,value:h,onChange:le=>d(le.target.value)}),v.jsxs(zN,{children:[v.jsx("label",{children:"사진"}),v.jsxs(BN,{children:[v.jsxs(HN,{onClick:()=>B.current.click(),children:[v.jsx("span",{className:"img-icon",children:v.jsx("img",{src:"/Team3-WebApp//image.svg",alt:""})}),v.jsxs("span",{className:"img-length",children:[k.length,"/",et]})]}),v.jsx("input",{ref:B,type:"file",accept:"image/*",multiple:!0,style:{display:"none"},onChange:Qe}),k.map((le,me)=>v.jsxs(FN,{children:[v.jsx("img",{src:le.src,alt:le.name}),v.jsx("button",{onClick:()=>X(me),children:v.jsx("img",{src:"/Team3-WebApp//delete.svg",alt:"삭제"})})]},me))]})]})]})]}),v.jsxs(GN,{children:[v.jsx("p",{className:"title",children:"공동구매 진행 정보"}),v.jsxs($N,{children:[v.jsxs(JN,{children:[v.jsx("label",{children:"마감기한"}),v.jsxs(e7,{selected:!!g,onClick:()=>U(!0),children:[g||"마감 기한을 선택해주세요",v.jsx("span",{children:v.jsx("img",{src:"/Team3-WebApp//calendar.svg",alt:""})})]})]}),v.jsx(qN,{hasValue:_!=="",children:v.jsx(Mo,{label:"가격",placeholder:"상품의 가격을 입력해주세요",value:re(_),onChange:le=>{const me=J(le.target.value);E(me)}})}),v.jsxs(YN,{children:[v.jsx(Mo,{label:"모집인원",placeholder:"공동구매할 인원을 입력해주세요",value:w,onChange:le=>C(le.target.value)}),ce!==null&&v.jsxs(KN,{children:[v.jsx("img",{src:"/Team3-WebApp//price.svg",alt:""}),v.jsxs("span",{children:["1인당"," ",v.jsx(QN,{children:ce.toLocaleString()}),"원이에요!"]})]})]}),v.jsx(Mo,{label:"상품링크",placeholder:"상품 링크를 입력해주세요",value:O,onChange:le=>z(le.target.value)})]})]}),D&&v.jsx(tk,{onClose:()=>A(!1),onSelect:I}),j&&v.jsx(PN,{onClose:()=>U(!1),onSelectDate:M})]})}const n7=R.div`
  display: flex;
  align-items: center;
  gap: 4px;
`,r7=R.div`
...
`;function g7(t){const e=bn(),[n,a]=F.useState(0),[s,l]=F.useState(""),[h,d]=F.useState([]),g=F.useRef(null),_=ei().state,E=_.title,w=async()=>{const V=new Date().getTime().toString(),B=rl(ti(Cn,"review"),V);try{await KT(B,{id:_.date,images:h,rating:n,title:E,date:V,bodys:s,comment:[]});const W=rl(Cn,"gongu",_.id);await Hy(W,{isReviewed:!0}),alert("리뷰가 작성되었습니다."),e("/community")}catch(W){console.error("리뷰 작성 실패 또는 gongu 업데이트 실패:",W)}},C=s.trim(),O=5,z=V=>{const B=O-h.length,J=Array.from(V.target.files).slice(0,B).map(re=>new Promise(ce=>{const D=new FileReader;D.onload=A=>ce({name:re.name,src:A.target.result}),D.readAsDataURL(re)}));Promise.all(J).then(re=>d(ce=>[...ce,...re]))},k=V=>d(h.filter((B,W)=>W!==V));return v.jsxs(a7,{children:[v.jsx(s7,{children:v.jsx("img",{src:"/Team3-WebApp//StatusBar.png",alt:"StatusBar"})}),v.jsx(Va,{state:"TextActionBar",text:"후기 작성",disabled:!C,onClick:w}),v.jsxs(o7,{children:[v.jsxs(l7,{children:[v.jsx("p",{children:E}),v.jsx("span",{children:v.jsx("img",{src:"/Team3-WebApp//arrow-right.svg",alt:""})})]}),v.jsxs(u7,{children:[v.jsxs(c7,{children:[v.jsx("label",{children:"평점"}),v.jsx(i7,{rating:n,onChange:a})]}),v.jsx(Mo,{label:"내용",placeholder:"공동구매한 상품에 대한 리뷰를 남겨주세요.",textarea:!0,value:s,onChange:V=>l(V.target.value)}),v.jsxs(h7,{children:[v.jsx("label",{children:"사진"}),v.jsxs(f7,{children:[v.jsxs(d7,{onClick:()=>g.current.click(),children:[v.jsx("span",{className:"img-icon",children:v.jsx("img",{src:"/Team3-WebApp//image.svg",alt:""})}),v.jsxs("span",{className:"img-length",children:[h.length,"/",O]})]}),v.jsx("input",{ref:g,type:"file",accept:"image/*",multiple:!0,style:{display:"none"},onChange:z}),h.map((V,B)=>v.jsxs(p7,{children:[v.jsx("img",{src:V.src,alt:V.name}),v.jsx("button",{onClick:()=>k(B),children:v.jsx("img",{src:"/Team3-WebApp//delete.svg",alt:"삭제"})})]},B))]})]})]})]})]})}const m7=R.div`
  display: flex;
  justify-content: center;
...
`;function P7(){const t=bn(),[e,n]=F.useState("ongoing"),[a,s]=F.useState([]);return F.useEffect(()=>{(async()=>{const h=ti(Cn,"gongu"),d=await Hi(h),g=[],m=new Date;d.forEach(_=>{var k;const E=_.data();let w;(k=E.deadline)!=null&&k.seconds?w=new Date(E.deadline.seconds*1e3):w=new Date(E.deadline);const O=(Array.isArray(E.participant)?E.participant.length:0)>=E.finalnum||w.setHours(0,0,0,0)<m.setHours(0,0,0,0);Array.isArray(E.participant)&&E.participant.includes("이영재_123456")&&g.push({id:_.id,...E,isDone:O})}),s(g)})()},[]),v.jsxs(D7,{children:[v.jsx(O7,{children:v.jsx("img",{src:"/Team3-WebApp//StatusBar.png",alt:"StatusBar"})}),v.jsx(Va,{state:"Title",title:"공구 현황"}),v.jsx(R2,{activeKey:e,onChange:n,tabs:[{key:"ongoing",label:"진행중인 공구"},{key:"done",label:"완료된 공구"}]}),v.jsx(k7,{children:a.filter(l=>e==="ongoing"?!l.isDone:l.isDone).length===0?v.jsxs(N7,{children:[v.jsx("p",{children:e==="ongoing"?"진행중인 공구가 없어요.":"완료된 공구가 없어요."}),v.jsxs(M7,{onClick:()=>t("/gongu/new"),children:[v.jsx("p",{children:"새로운 공구 올리기"}),v.jsx("span",{children:v.jsx("img",{src:"/Team3-WebApp//arrow-right-blue.svg",alt:">"})})]})]}):a.filter(l=>e==="ongoing"?!l.isDone:l.isDone).map(l=>v.jsx(I7,{gongu:l},l.id))}),v.jsx(sd,{})]})}const j7=R.section`
  display: flex;
  padding: 12px 0 86px;
  flex-direction: column;
  align-items: flex-start;
...
`,H7=R.button`
  ...
  cursor: pointer;
`;function F7(){const t=bn(),[e,n]=F.useState("review");return v.jsxs(U7,{children:[v.jsx(z7,{children:v.jsx("img",{src:"/Team3-WebApp//StatusBar.png",alt:"StatusBar"})}),v.jsx(Va,{state:"Title",title:"커뮤니티",rightIcon:v.jsx("img",{src:"/Team3-WebApp//search.svg",alt:"search"})}),v.jsx(R2,{activeKey:e,onChange:n,tabs:[{key:"review",label:"후기"},{key:"question",label:"질문"}]}),e==="review"?v.jsx(L7,{}):v.jsxs(B7,{children:[v.jsx("p",{children:"아직 질문이 없어요"}),v.jsx("p",{children:"첫 번째 질문을 남겨보세요!"})]}),v.jsx(H7,{onClick:()=>t("/selectGongu"),children:v.jsx("img",{src:"/Team3-WebApp//plus.svg",alt:""})}),v.jsx(sd,{})]})}const G7=R.div`
  display:flex;
  gap:8px;
  align-items:center;
`,$7=R.div`
...
`,ZM=R.button`
  ...
  letter-spacing: -0.4px;
  border: none;
`;function JM({onSubmit:t}){const[e,n]=F.useState(""),a=l=>{n(l.target.value)},s=()=>{e.trim()?(t(e),n("")):alert("댓글을 입력해주세요.")};return v.jsxs(QM,{children:[v.jsx(XM,{placeholder:"댓글을 입력해주세요.",value:e,onChange:a}),v.jsx(ZM,{onClick:s,children:"등록"})]})}const eP=R.div`
  width: 402px;
  height: 50px;
  background: #fff;
...
`;function fP(t){const a=(Date.now()-t)/1e3,s=a/60,l=s/60,h=l/24,d=h/7;return a<60?"방금전":s<60?`${Math.floor(s)}분전`:l<24?`${Math.floor(l)}시간전`:h<7?`${Math.floor(h)}일전`:`${Math.floor(d)}주전`}function dP(){const[t,e]=F.useState(0),n=F.useRef(null),a=bn(),s=Hb().id,[l,h]=F.useState(null);F.useEffect(()=>{(async()=>{try{const J=rl(Cn,"review",s),re=await e9(J);re.exists()?h({id:re.id,...re.data()}):console.log("문서가 존재하지 않습니다.")}catch(J){console.error("문서 불러오기 실패:",J)}})()},[s]);const d=()=>{const W=n.current.scrollLeft,J=Math.round(W/402);e(J)},g=()=>{a(-1)},m=()=>{a(`/gongu/${l.id}`,{state:{item:l}})},_=async W=>{const J={id:Date.now(),time:Date.now(),comments:W};try{const re=rl(Cn,"review",s);await Hy(re,{comment:n9(J)}),h(ce=>({...ce,comment:[...ce.comment,J]}))}catch(re){console.error("댓글 작성 실패:",re)}};if(!l)return v.jsx("div",{children:"불러오는 중..."});const E=new Date(Number(l.date)),w=E.getFullYear(),C=String(E.getMonth()+1).padStart(2,"0"),O=String(E.getDate()).padStart(2,"0"),z=String(E.getHours()).padStart(2,"0"),k=String(E.getMinutes()).padStart(2,"0"),V=`${w}.${C}.${O}`,B=`${z}:${k}`;return v.jsxs(tP,{children:[v.jsx(eP,{children:v.jsx("img",{src:"/Team3-WebApp//StatusBar.png",alt:"StatusBar"})}),v.jsx(Va,{state:"IconActionBar",onClick:g}),l.images&&l.images.length>0&&v.jsxs(lP,{children:[v.jsx(iP,{ref:n,onScroll:d,children:l.images.map((W,J)=>v.jsx(aP,{src:W.src,alt:`이미지${J}번`},J))}),l.images.length>1&&v.jsx(sP,{children:l.images.map((W,J)=>v.jsx(oP,{active:J===t},J))})]}),v.jsxs(nP,{children:[v.jsxs(cP,{children:[v.jsx(ZT,{rating:l.rating}),v.jsx(UM,{onClick:m,children:l.title})]}),v.jsx(I2,{owner:"공구킹영재",date:V,time:B}),v.jsx(uP,{children:l.bodys})]}),v.jsxs(rP,{children:[v.jsxs(hP,{children:[v.jsx("p",{className:"gray400",children:"댓글"}),v.jsx("p",{className:"blue01",children:l.comment.length})]}),l.comment.map((W,J)=>v.jsx(KM,{ago:fP(W.time),text:W.comments,alt:`댓글${J}번`},W.id))]}),v.jsx(JM,{onSubmit:_})]})}const pP=R.div`
  background: white;
  width: 402px;
  min-height: 100vh;
  font-family: Pretendard;
