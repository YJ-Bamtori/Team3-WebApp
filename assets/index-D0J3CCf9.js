...
`,YC=R.div`
  ...
  text-align: center;
`,KC=({currentStep:t=0})=>{const n=["모집중","모집완료","결제대기","배송중"],a=t/3*100;return v.jsxs(BC,{children:[v.jsxs(HC,{children:[v.jsx(GC,{}),v.jsx($C,{$progress:a}),[...Array(4)].map((s,l)=>v.jsxs(FC,{$active:l===t,$completed:l<t,children:[l===t&&v.jsx("img",{src:"/Team3-WebApp//dot.svg",alt:"현재 단계"}),l<t&&v.jsx("img",{src:"/Team3-WebApp//check.svg",alt:"완료됨"})]},l))]}),v.jsx(qC,{children:n.map((s,l)=>v.jsx(YC,{$active:l<=t,children:s},s))})]})},QC=R.div`
  display: flex;
  align-items: center;
  gap: 2px;
`,WC=R.span`
...
`,JC=R.span`
  color: #797979;
`;function Wm({current:t=0,total:e=0}){return v.jsxs(QC,{children:[v.jsx(WC,{children:v.jsx("img",{src:"/participant.svg",alt:""})}),v.jsxs(XC,{children:[v.jsx(ZC,{children:t}),v.jsxs(JC,{children:["/",e]})]})]})}const eR=R.div`
  font-size: 16px;
  font-weight: 600;
  line-height: 24px;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wu(t){return t.endsWith(".cloudworkstations.dev")}async function Dw(t){return(await fetch(t,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k6="firebase-heartbeat-database",N6=1,ju="firebase-heartbeat-store";let Cg=null;function jw(){return Cg||(Cg=WR(k6,N6,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(ju)}catch(n){console.warn(n)}}}}).catch(t=>{throw Aa.create("idb-open",{originalErrorMessage:t.message})})),Cg}async function M6(t){try{const n=(await jw()).transaction(ju),a=await n.objectStore(ju).get(Vw(t));return await n.done,a}catch(e){if(e instanceof Bi)Pi.warn(e.message);else{const n=Aa.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Pi.warn(n.message)}}}async function W_(t,e){try{const a=(await jw()).transaction(ju,"readwrite");await a.objectStore(ju).put(e,Vw(t)),await a.done}catch(n){if(n instanceof Bi)Pi.warn(n.message);else{const a=Aa.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});Pi.warn(a.message)}}}function Vw(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rx(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Qw(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(qw(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Xw(e))return"Blackberry";if(Zw(e))return"Webos";if(Yw(e))return"Safari";if((e.includes("chrome/")||Kw(e))&&!e.includes("edge/"))return"Chrome";if(Ww(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,a=t.match(n);if((a==null?void 0:a.length)===2)return a[1]}return"Other"}function qw(t=xn()){return/firefox\//i.test(t)}function Yw(t=xn()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Kw(t=xn()){return/crios\//i.test(t)}function Qw(t=xn()){return/iemobile/i.test(t)}function Ww(t=xn()){return/android/i.test(t)}function Xw(t=xn()){return/blackberry/i.test(t)}function Zw(t=xn()){return/webos/i.test(t)}function sy(t=xn()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function l3(t=xn()){var e;return sy(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function u3(){return ER()&&document.documentMode===10}function Jw(t=xn()){return sy(t)||Ww(t)||Zw(t)||Xw(t)||/windows phone/i.test(t)||Qw(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const W3="pendingRedirect",Wh=new Map;class X3 extends dE{constructor(e,n,a=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,a),this.eventId=null}async execute(){let e=Wh.get(this.auth._key());if(!e){try{const a=await Z3(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(a)}catch(n){e=()=>Promise.reject(n)}Wh.set(this.auth._key(),e)}return this.bypassAuthState||Wh.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Z3(t,e){const n=tI(e),a=eI(t);if(!await a._isAvailable())return!1;const s=await a._get(n)==="true";return await a._remove(n),s}function J3(t,e){Wh.set(t._key(),e)}function eI(t){return Oi(t._redirectPersistence)}function tI(t){return Qh(W3,t.config.apiKey,t.name)}async function nI(t,e,n=!1){if(Fr(t.app))return Promise.reject(Ss(t));const a=oy(t),s=$3(a,e),h=await new X3(a,s,n).execute();return h&&!n&&(delete h.user._redirectEventId,await a._persistUserIfCurrent(h.user),await a._setRedirectUser(null,e)),h}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ds=new Jm("@firebase/firestore");function Do(){return Ds.logLevel}function de(t,...e){if(Ds.logLevel<=ze.DEBUG){const n=e.map(hy);Ds.debug(`Firestore (${cl}): ${t}`,...n)}}function Li(t,...e){if(Ds.logLevel<=ze.ERROR){const n=e.map(hy);Ds.error(`Firestore (${cl}): ${t}`,...n)}}function Wo(t,...e){if(Ds.logLevel<=ze.WARN){const n=e.map(hy);Ds.warn(`Firestore (${cl}): ${t}`,...n)}}function hy(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kn{constructor(e){this.value=e}static empty(){return new kn({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let n=this.value;for(let a=0;a<e.length-1;++a)if(n=(n.mapValue.fields||{})[e.get(a)],!ef(n))return null;return n=(n.mapValue.fields||{})[e.lastSegment()],n||null}}set(e,n){this.getFieldsMap(e.popLast())[e.lastSegment()]=Iu(n)}setAll(e){let n=hn.emptyPath(),a={},s=[];e.forEach((h,d)=>{if(!n.isImmediateParentOf(d)){const g=this.getFieldsMap(n);this.applyChanges(g,a,s),a={},s=[],n=d.popLast()}h?a[d.lastSegment()]=Iu(h):s.push(d.lastSegment())});const l=this.getFieldsMap(n);this.applyChanges(l,a,s)}delete(e){const n=this.field(e.popLast());ef(n)&&n.mapValue.fields&&delete n.mapValue.fields[e.lastSegment()]}isEqual(e){return Wr(this.value,e.value)}getFieldsMap(e){let n=this.value;n.mapValue.fields||(n.mapValue={fields:{}});for(let a=0;a<e.length;++a){let s=n.mapValue.fields[e.get(a)];ef(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},n.mapValue.fields[e.get(a)]=s),n=s}return n.mapValue.fields}applyChanges(e,n,a){La(n,(s,l)=>e[s]=l);for(const s of a)delete e[s]}clone(){return new kn(Iu(this.value))}}function ME(t){const e=[];return La(t.fields,(n,a)=>{const s=new hn([n]);if(ef(a)){const l=ME(a.mapValue).fields;if(l.length===0)e.push(s);else for(const h of l)e.push(s.child(h))}else e.push(s)}),new qn(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wf{constructor(e,n,a,s,l){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=a,this.documentUpdates=s,this.resolvedLimboDocuments=l}static createSynthesizedRemoteEventForCurrentChange(e,n,a){const s=new Map;return s.set(e,rc.createSynthesizedTargetChangeForCurrentChange(e,n,a)),new Wf(Re.min(),s,new wt(Me),Ui(),Be())}}class rc{constructor(e,n,a,s,l){this.resumeToken=e,this.current=n,this.addedDocuments=a,this.modifiedDocuments=s,this.removedDocuments=l}static createSynthesizedTargetChangeForCurrentChange(e,n,a){return new rc(a,n,Be(),Be(),Be())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qx="ConnectivityMonitor";class Wx{constructor(){this.Bo=()=>this.Lo(),this.ko=()=>this.qo(),this.Qo=[],this.$o()}No(e){this.Qo.push(e)}shutdown(){window.removeEventListener("online",this.Bo),window.removeEventListener("offline",this.ko)}$o(){window.addEventListener("online",this.Bo),window.addEventListener("offline",this.ko)}Lo(){de(Qx,"Network connectivity changed: AVAILABLE");for(const e of this.Qo)e(0)}qo(){de(Qx,"Network connectivity changed: UNAVAILABLE");for(const e of this.Qo)e(1)}static C(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xf(t){return new QD(t,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,E9=R.div`
  ...
  flex: 1;
  margin: 4px 0 12px;
`;function T9({title:t,price:e,deadline:n,current:a,finalnum:s,onClick:l,images:h}){const d=Array.isArray(h)?h[0]:h;return v.jsxs(b9,{onClick:l,children:[v.jsx(w9,{$image:d}),v.jsx(Qu,{label:n}),v.jsxs(E9,{children:[v.jsx(Zm,{title:t}),v.jsx(Xm,{amount:parseInt(e/s)})]}),v.jsx(Wm,{current:a,total:s})]})}const S9=R.section`
  display: flex;
  flex-direction: column;
  padding: 16px 0;
  width: 100%;
...
`,Z9=R.div`
  ...
  align-items: flex-start;
  align-self: stretch;
`,J9=()=>{const t=bn(),[e,n]=F.useState([]);return F.useEffect(()=>{(async()=>{try{const l=(await Hi(ti(Cn,"review"))).docs.map(h=>({id:h.id,...h.data()})).sort((h,d)=>(d.date??0)-(h.date??0));n(l)}catch(s){console.error("커뮤니티 데이터 불러오기 실패:",s)}})()},[]),v.jsxs(K9,{children:[v.jsxs(Q9,{children:[v.jsx(W9,{children:"커뮤니티"}),v.jsxs(X9,{onClick:()=>t("/community"),children:[v.jsx("p",{children:"전체보기"}),v.jsx("span",{children:v.jsx("img",{src:"/arrow-right-16px.svg",alt:""})})]})]}),v.jsx(Z9,{children:e.length===0?v.jsx("p",{style:{color:"#999",fontSize:"14px"},children:"게시물이 없어요"}):e.slice(0,5).map((a,s)=>v.jsx(JT,{...a,onClick:()=>t(`/community/${a.date}`)},a.id||s))})]})},eO=R.section`
  width: 100%;
`,tO=R.div`
  color: #232428;
  font-size: 24px;
...
`;function g7(t){const e=bn(),[n,a]=F.useState(0),[s,l]=F.useState(""),[h,d]=F.useState([]),g=F.useRef(null),_=ei().state,E=_.title,w=async()=>{const V=new Date().getTime().toString(),B=rl(ti(Cn,"review"),V);try{await QT(B,{id:_.date,images:h,rating:n,title:E,date:V,bodys:s,comment:[]});const K=rl(Cn,"gongu",_.id);await Hy(K,{isReviewed:!0}),alert("리뷰가 작성되었습니다."),e("/community")}catch(K){console.error("리뷰 작성 실패 또는 gongu 업데이트 실패:",K)}},C=s.trim(),O=5,z=V=>{const B=O-h.length,J=Array.from(V.target.files).slice(0,B).map(re=>new Promise(ce=>{const D=new FileReader;D.onload=A=>ce({name:re.name,src:A.target.result}),D.readAsDataURL(re)}));Promise.all(J).then(re=>d(ce=>[...ce,...re]))},k=V=>d(h.filter((B,K)=>K!==V));return v.jsxs(a7,{children:[v.jsx(s7,{children:v.jsx("img",{src:"/StatusBar.png",alt:"StatusBar"})}),v.jsx(Va,{state:"TextActionBar",text:"후기 작성",disabled:!C,onClick:w}),v.jsxs(o7,{children:[v.jsxs(l7,{children:[v.jsx("p",{children:E}),v.jsx("span",{children:v.jsx("img",{src:"/arrow-right.svg",alt:""})})]}),v.jsxs(u7,{children:[v.jsxs(c7,{children:[v.jsx("label",{children:"평점"}),v.jsx(i7,{rating:n,onChange:a})]}),v.jsx(Mo,{label:"내용",placeholder:"공동구매한 상품에 대한 리뷰를 남겨주세요.",textarea:!0,value:s,onChange:V=>l(V.target.value)}),v.jsxs(h7,{children:[v.jsx("label",{children:"사진"}),v.jsxs(f7,{children:[v.jsxs(d7,{onClick:()=>g.current.click(),children:[v.jsx("span",{className:"img-icon",children:v.jsx("img",{src:"/image.svg",alt:""})}),v.jsxs("span",{className:"img-length",children:[h.length,"/",O]})]}),v.jsx("input",{ref:g,type:"file",accept:"image/*",multiple:!0,style:{display:"none"},onChange:z}),h.map((V,B)=>v.jsxs(p7,{children:[v.jsx("img",{src:V.src,alt:V.name}),v.jsx("button",{onClick:()=>k(B),children:v.jsx("img",{src:"/delete.svg",alt:"삭제"})})]},B))]})]})]})]})]})}const m7=R.div`
  display: flex;
  justify-content: center;
...
`,ZM=R.button`
  ...
  letter-spacing: -0.4px;
  border: none;
`;function JM({onSubmit:t}){const[e,n]=F.useState(""),a=l=>{n(l.target.value)},s=()=>{e.trim()?(t(e),n("")):alert("댓글을 입력해주세요.")};return v.jsxs(WM,{children:[v.jsx(XM,{placeholder:"댓글을 입력해주세요.",value:e,onChange:a}),v.jsx(ZM,{onClick:s,children:"등록"})]})}const eP=R.div`
  width: 402px;
  height: 50px;
  background: #fff;
