...
`,YC=R.div`
  ...
  text-align: center;
`,KC=({currentStep:t=0})=>{const n=["모집중","모집완료","결제대기","배송중"],a=t/3*100;return v.jsxs(BC,{children:[v.jsxs(HC,{children:[v.jsx(GC,{}),v.jsx($C,{$progress:a}),[...Array(4)].map((s,l)=>v.jsxs(FC,{$active:l===t,$completed:l<t,children:[l===t&&v.jsx("img",{src:"/Team3-WebApp//dot.svg",alt:"현재 단계"}),l<t&&v.jsx("img",{src:"/Team3-WebApp//check.svg",alt:"완료됨"})]},l))]}),v.jsx(qC,{children:n.map((s,l)=>v.jsx(YC,{$active:l<=t,children:s},s))})]})},WC=R.div`
  display: flex;
  align-items: center;
  gap: 2px;
`,QC=R.span`
...
`,JC=R.span`
  color: #797979;
`;function Qm({current:t=0,total:e=0}){return v.jsxs(WC,{children:[v.jsx(QC,{children:v.jsx("img",{src:"/Team3-WebApp//participant.svg",alt:""})}),v.jsxs(XC,{children:[v.jsx(ZC,{children:t}),v.jsxs(JC,{children:["/",e]})]})]})}const eR=R.div`
  font-size: 16px;
  font-weight: 600;
  line-height: 24px;
...
`;function Xm({amount:t="1,100원",unit:e="/ 인",color:n="#426bff",unitColor:a="#66686E"}){return v.jsxs(eR,{children:[v.jsx(tR,{style:{color:n},children:`${t==null?void 0:t.toLocaleString()}원 `}),v.jsx(nR,{style:{color:a},children:e})]})}const rR=R.div`
  ...
  width: fit-content;
`;function Wu({label:t}){const e=new Date,n=new Date(t);let a=`${Math.ceil((n-e)/(1e3*60*60*24))}`;return a<0?a="마감됨":a>0?a=`D-${a}`:a="D-Day",v.jsx(rR,{children:a})}const iR=R.h2`
  color: #333;
  font-family: Pretendard;
  font-size: 16px;
  font-style: normal;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Y6(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(q6()||bR()||"connection"in navigator)?navigator.onLine:!0}function K6(){if(typeof navigator>"u")return null;const t=navigator;return t.languages&&t.languages[0]||t.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rx(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Ww(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(qw(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Xw(e))return"Blackberry";if(Zw(e))return"Webos";if(Yw(e))return"Safari";if((e.includes("chrome/")||Kw(e))&&!e.includes("edge/"))return"Chrome";if(Qw(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,a=t.match(n);if((a==null?void 0:a.length)===2)return a[1]}return"Other"}function qw(t=xn()){return/firefox\//i.test(t)}function Yw(t=xn()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Kw(t=xn()){return/crios\//i.test(t)}function Ww(t=xn()){return/iemobile/i.test(t)}function Qw(t=xn()){return/android/i.test(t)}function Xw(t=xn()){return/blackberry/i.test(t)}function Zw(t=xn()){return/webos/i.test(t)}function sy(t=xn()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function l3(t=xn()){var e;return sy(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function u3(){return ER()&&document.documentMode===10}function Jw(t=xn()){return sy(t)||Qw(t)||Zw(t)||Xw(t)||/windows phone/i.test(t)||Ww(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wo{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,n,a,s=!1){const l=await xr._fromIdTokenResponse(e,a,s),h=sx(a);return new Wo({user:l,providerId:h,_tokenResponse:a,operationType:n})}static async _forOperation(e,n,a){await e._updateTokensIfNecessary(a,!0);const s=sx(a);return new Wo({user:e,providerId:s,_tokenResponse:a,operationType:n})}}function sx(t){return t.providerId?t.providerId:"phoneNumber"in t?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function A3(t,e,n=!1){const{auth:a}=t;if(Fr(a.app))return Promise.reject(Ss(a));const s="reauthenticate";try{const l=await Vu(t,iE(a,s,e,t),n);Ce(l.idToken,a,"internal-error");const h=ay(l.idToken);Ce(h,a,"internal-error");const{sub:d}=h;return Ce(t.uid===d,a,"user-mismatch"),Wo._forOperation(t,s,l)}catch(l){throw(l==null?void 0:l.code)==="auth/user-not-found"&&ji(a,"user-mismatch"),l}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function C3(t,e,n=!1){if(Fr(t.app))return Promise.reject(Ss(t));const a="signIn",s=await iE(t,a,e),l=await Wo._fromIdTokenResponse(t,a,s);return n||await t._updateCurrentUser(l.user),l}function R3(t,e,n,a){return Pn(t).onIdTokenChanged(e,n,a)}function I3(t,e,n){return Pn(t).beforeAuthStateChanged(e,n)}const mf="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kf{constructor(){this._=void 0}}function kD(t,e,n){return t instanceof Ef?function(s,l){const h={fields:{[IE]:{stringValue:RE},[OE]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return l&&dy(l)&&(l=Gf(l)),l&&(h.fields[DE]=l),{mapValue:h}}(n,e):t instanceof el?KE(t,e):t instanceof Hu?WE(t,e):function(s,l){const h=YE(s,l),d=Px(h)+Px(s.Re);return cm(h)&&cm(s.Re)?qE(d):vy(s.serializer,d)}(t,e)}function ND(t,e,n){return t instanceof el?KE(t,e):t instanceof Hu?WE(t,e):n}function YE(t,e){return t instanceof Tf?function(a){return cm(a)||function(l){return!!l&&"doubleValue"in l}(a)}(e)?e:{integerValue:0}:null}class Ef extends Kf{}class el extends Kf{constructor(e){super(),this.elements=e}}function KE(t,e){const n=QE(e);for(const a of t.elements)n.some(s=>Qr(s,a))||n.push(a);return{arrayValue:{values:n}}}class Hu extends Kf{constructor(e){super(),this.elements=e}}function WE(t,e){let n=QE(e);for(const a of t.elements)n=n.filter(s=>!Qr(s,a));return{arrayValue:{values:n}}}class Tf extends Kf{constructor(e,n){super(),this.serializer=e,this.Re=n}}function Px(t){return It(t.integerValue||t.doubleValue)}function QE(t){return py(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wx="ConnectivityMonitor";class Qx{constructor(){this.Bo=()=>this.Lo(),this.ko=()=>this.qo(),this.Qo=[],this.$o()}No(e){this.Qo.push(e)}shutdown(){window.removeEventListener("online",this.Bo),window.removeEventListener("offline",this.ko)}$o(){window.addEventListener("online",this.Bo),window.addEventListener("offline",this.ko)}Lo(){de(Wx,"Network connectivity changed: AVAILABLE");for(const e of this.Qo)e(0)}qo(){de(Wx,"Network connectivity changed: UNAVAILABLE");for(const e of this.Qo)e(1)}static C(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xf(t){return new WD(t,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,E9=R.div`
  ...
  flex: 1;
  margin: 4px 0 12px;
`;function T9({title:t,price:e,deadline:n,current:a,finalnum:s,onClick:l,images:h}){const d=Array.isArray(h)?h[0]:h;return v.jsxs(b9,{onClick:l,children:[v.jsx(w9,{$image:d}),v.jsx(Wu,{label:n}),v.jsxs(E9,{children:[v.jsx(Zm,{title:t}),v.jsx(Xm,{amount:parseInt(e/s)})]}),v.jsx(Qm,{current:a,total:s})]})}const S9=R.section`
  display: flex;
  flex-direction: column;
  padding: 16px 0;
  width: 100%;
...
`,Z9=R.div`
  ...
  align-items: flex-start;
  align-self: stretch;
`,J9=()=>{const t=bn(),[e,n]=F.useState([]);return F.useEffect(()=>{(async()=>{try{const l=(await Hi(ti(Cn,"review"))).docs.map(h=>({id:h.id,...h.data()})).sort((h,d)=>(d.date??0)-(h.date??0));n(l)}catch(s){console.error("커뮤니티 데이터 불러오기 실패:",s)}})()},[]),v.jsxs(K9,{children:[v.jsxs(W9,{children:[v.jsx(Q9,{children:"커뮤니티"}),v.jsxs(X9,{onClick:()=>t("/community"),children:[v.jsx("p",{children:"전체보기"}),v.jsx("span",{children:v.jsx("img",{src:"/arrow-right-16px.svg",alt:""})})]})]}),v.jsx(Z9,{children:e.length===0?v.jsx("p",{style:{color:"#999",fontSize:"14px"},children:"게시물이 없어요"}):e.slice(0,5).map((a,s)=>v.jsx(JT,{...a,onClick:()=>t(`/community/${a.date}`)},a.id||s))})]})},eO=R.section`
  width: 100%;
`,tO=R.div`
  color: #232428;
  font-size: 24px;
...
`;function fP(t){const a=(Date.now()-t)/1e3,s=a/60,l=s/60,h=l/24,d=h/7;return a<60?"방금전":s<60?`${Math.floor(s)}분전`:l<24?`${Math.floor(l)}시간전`:h<7?`${Math.floor(h)}일전`:`${Math.floor(d)}주전`}function dP(){const[t,e]=F.useState(0),n=F.useRef(null),a=bn(),s=Hb().id,[l,h]=F.useState(null);F.useEffect(()=>{(async()=>{try{const J=rl(Cn,"review",s),re=await e9(J);re.exists()?h({id:re.id,...re.data()}):console.log("문서가 존재하지 않습니다.")}catch(J){console.error("문서 불러오기 실패:",J)}})()},[s]);const d=()=>{const K=n.current.scrollLeft,J=Math.round(K/402);e(J)},g=()=>{a(-1)},m=()=>{a(`/gongu/${l.id}`,{state:{item:l}})},_=async K=>{const J={id:Date.now(),time:Date.now(),comments:K};try{const re=rl(Cn,"review",s);await Hy(re,{comment:n9(J)}),h(ce=>({...ce,comment:[...ce.comment,J]}))}catch(re){console.error("댓글 작성 실패:",re)}};if(!l)return v.jsx("div",{children:"불러오는 중..."});const E=new Date(Number(l.date)),w=E.getFullYear(),C=String(E.getMonth()+1).padStart(2,"0"),O=String(E.getDate()).padStart(2,"0"),z=String(E.getHours()).padStart(2,"0"),k=String(E.getMinutes()).padStart(2,"0"),V=`${w}.${C}.${O}`,B=`${z}:${k}`;return v.jsxs(tP,{children:[v.jsx(eP,{children:v.jsx("img",{src:"/Team3-WebApp//StatusBar.png",alt:"StatusBar"})}),v.jsx(Va,{state:"IconActionBar",onClick:g}),l.images&&l.images.length>0&&v.jsxs(lP,{children:[v.jsx(iP,{ref:n,onScroll:d,children:l.images.map((K,J)=>v.jsx(aP,{src:K.src,alt:`이미지${J}번`},J))}),l.images.length>1&&v.jsx(sP,{children:l.images.map((K,J)=>v.jsx(oP,{active:J===t},J))})]}),v.jsxs(nP,{children:[v.jsxs(cP,{children:[v.jsx(ZT,{rating:l.rating}),v.jsx(UM,{onClick:m,children:l.title})]}),v.jsx(I2,{owner:"공구킹영재",date:V,time:B}),v.jsx(uP,{children:l.bodys})]}),v.jsxs(rP,{children:[v.jsxs(hP,{children:[v.jsx("p",{className:"gray400",children:"댓글"}),v.jsx("p",{className:"blue01",children:l.comment.length})]}),l.comment.map((K,J)=>v.jsx(WM,{ago:fP(K.time),text:K.comments,alt:`댓글${J}번`},K.id))]}),v.jsx(JM,{onSubmit:_})]})}const pP=R.div`
  background: white;
  width: 402px;
  min-height: 100vh;
  font-family: Pretendard;
